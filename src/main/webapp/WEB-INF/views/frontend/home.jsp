                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="${BASE_URL}/assets/img/hero-img-1.png" class="img-fluid w-100 h-100 bg-secondary rounded"
                                         alt="First slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Fruites</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="${BASE_URL}/assets/img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded"
                                         alt="Second slide">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="${BASE_URL}/assets/img/fruite-item-5.jpg" class="img-fluid w-100 rounded-top"
                                                         alt="">
                                                </div>
